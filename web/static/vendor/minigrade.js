...
var _user$project$Minigrade$main = {
	main: _elm_lang$html$Html$text('Hello asdafrom Elm!')
};

var Elm = {};
Elm['Minigrade'] = Elm['Minigrade'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Minigrade'], 'Minigrade', typeof _user$project$Minigrade$main === 'undefined' ? null : _user$project$Minigrade$main);
